...
public class ApfelWorker {
	...
	private double calculateDistance(double xstart,double ystart, double xend, double yend) {
	...
	private int iterateFunction (double x, double y) {
		...
		int iter =0;
		while (iter < maxiter && radius >= calculateDistance (start[0], start[1], p[0], p[1])) {
